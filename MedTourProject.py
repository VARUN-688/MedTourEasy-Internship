...
ax.plot(lefthanded_data.Age,lefthanded_data.Female,color="y",marker = 'o') # plot "Female" vs. "Age"
ax.plot(lefthanded_data.Age,lefthanded_data.Male, color="r",marker = 'x') # plot "Male" vs. "Age"
...
lefthanded_data.insert(3,"Birth_Year",1986-lefthanded_data.Age)
lefthanded_data.insert(4,"Mean_lh",(lefthanded_data.Male+lefthanded_data.Female)/2)

fig, ax = plt.subplots()
ax.plot(lefthanded_data.Birth_Year,lefthanded_data.Mean_lh,color="r") # plot 'Mean_lh' vs. 'Birth_year'
ax.set_ylabel("Lefthandedness") # set the x label for the plot
ax.set_xlabel("Birth_year") # set the y label for the plot
...
def P_A_given_lh(ages_of_death, death_distribution_data, study_year = 1990):
    ...
    return P_lh_A*P_A["Both Sexes"]/P_left
...
def P_A_given_rh(ages_of_death, death_distribution_data, study_year = 1990):
    ...
    return P_rh_A*P_A["Both Sexes"]/P_right
...
fig, ax = plt.subplots()
ax.plot(ages, left_handed_probability,color="y",marker = 'o')
ax.plot(ages,  right_handed_probability, color="r",marker = 'x')
ax.legend(['LeftHanded Probability','Right Probability']) 
...
print(f"Average Lefthanded death=>{average_rh_age}\n Average Righthanded death=>{average_rh_age}")
...
print("The difference in average ages is " + 
      str(round(average_rh_age_2018 - average_lh_age_2018, 1)) + "years \n The average death for Right and Left Handed respectively are=>",average_rh_age_2018,average_lh_age_2018)
